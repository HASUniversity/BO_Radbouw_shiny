...
inlezen_samenmeten <- function() {
  ...
  Infor1 <- "https://api-samenmeten.rivm.nl/v1.0/Things(30017)" #30017 bestaat niet meer.
  ...
  Infor4 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104771)/Observations?$top=20&$skip=20"
  Infor5 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104771)/Observations?$top=20&$skip=40"
  Infor6 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104771)/Observations?$top=20&$skip=60"
  ...
  Infor9 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104773)/Observations?$top=20&$skip=20"
  Infor10 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104773)/Observations?$top=20&$skip=40"
  Infor11 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104773)/Observations?$top=20&$skip=60"
  Infor12 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104773)/ObservedProperty"
  
  # PM 2,5 gekalibreerde data
  Infor13 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104772)/Observations"
  Infor14 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104772)/Observations?$top=20&$skip=20"
  Infor15 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104772)/Observations?$top=20&$skip=40"
  Infor16 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104772)/Observations?$top=20&$skip=60"
  Infor17 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104772)/ObservedProperty"
  
  # PM 10 gekalibreerde data
  Infor18 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104774)/Observations"
  Infor19 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104774)/Observations?$top=20&$skip=20"
  Infor20 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104774)/Observations?$top=20&$skip=40"
  Infor21 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(104774)/Observations?$top=20&$skip=60"
