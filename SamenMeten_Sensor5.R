...
inlezensamenmeten <- function() {
  ...
  Infor1 <- "https://api-samenmeten.rivm.nl/v1.0/Things(30148)"
  Infor2 <- "https://api-samenmeten.rivm.nl/v1.0/Things(30148)/Locations"
  
  # pm25 data 
  Infor3 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105509)/Observations"
  Infor4 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105509)/Observations?$top=20&$skip=20"
  Infor5 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105509)/Observations?$top=20&$skip=40"
  Infor6 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105509)/Observations?$top=20&$skip=60"
  Infor7 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105509)/ObservedProperty"
  
  # pm10 data 
  Infor8 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105511)/Observations"
  Infor9 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105511)/Observations?$top=20&$skip=20"
  Infor10 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105511)/Observations?$top=20&$skip=40"
  Infor11 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105511)/Observations?$top=20&$skip=60"
  Infor12 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105511)/ObservedProperty"
  
  # pm25 kal data
  Infor13 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105510)/Observations"
  Infor14 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105510)/Observations?$top=20&$skip=20"
  Infor15 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105510)/Observations?$top=20&$skip=40"
  Infor16 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105510)/Observations?$top=20&$skip=60"
  Infor17 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105510)/ObservedProperty"
  
  # pm10 kal data
  Infor18 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105512)/Observations"
  Infor19 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105512)/Observations?$top=20&$skip=20"
  Infor20 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105512)/Observations?$top=20&$skip=40"
  Infor21 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105512)/Observations?$top=20&$skip=60"
  Infor22 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(105512)/ObservedProperty"
  ...
  saveRDS(SamenMeten_final, file = "LTD_24283.rds")
}