...
inlezensamenmeten <- function() {
  ...
  Infor1 <- "https://api-samenmeten.rivm.nl/v1.0/Things(30336)"
  Infor2 <- "https://api-samenmeten.rivm.nl/v1.0/Things(30336)/Locations"
  
  # pm25 data 
  Infor3 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106595)/Observations"
  Infor4 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106595)/Observations?$top=20&$skip=20"
  Infor5 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106595)/Observations?$top=20&$skip=40"
  Infor6 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106595)/Observations?$top=20&$skip=60"
  Infor7 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106595)/ObservedProperty"
  
  # pm10 data 
  Infor8 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106597)/Observations"
  Infor9 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106597)/Observations?$top=20&$skip=20"
  Infor10 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106597)/Observations?$top=20&$skip=40"
  Infor11 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106597)/Observations?$top=20&$skip=60"
  Infor12 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106597)/ObservedProperty"
  
  # pm25 kal data
  Infor13 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106596)/Observations"
  Infor14 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106596)/Observations?$top=20&$skip=20"
  Infor15 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106596)/Observations?$top=20&$skip=40"
  Infor16 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106596)/Observations?$top=20&$skip=60"
  Infor17 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106596)/ObservedProperty"
  
  # pm10 kal data
  Infor18 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106598)/Observations"
  Infor19 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106598)/Observations?$top=20&$skip=20"
  Infor20 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106598)/Observations?$top=20&$skip=40"
  Infor21 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106598)/Observations?$top=20&$skip=60"
  Infor22 <- "https://api-samenmeten.rivm.nl/v1.0/Datastreams(106598)/ObservedProperty"
  ...
  saveRDS(SamenMeten_final, file = "LTD_27720.rds")
} 